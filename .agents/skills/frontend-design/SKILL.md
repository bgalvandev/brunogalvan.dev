...
[[frontend-theming]]; numeric values stay in CSS, not duplicated in design memory.
...
Use plain action labels and synchronized catalogs ([[frontend-i18n]]). Read
...
Finish visible work with [[design-review]] using actual rendered evidence.
